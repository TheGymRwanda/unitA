  ...
  return (
    <Wrapper>
      <div className="mt-23.75 md:mt-24.5 xl:mt-45.75">
        ...
        <div className="lg:mt-13.25 pb-5 md:py-8.75 xl:py-4.5 text-2xl font-normal text-secondary md:text-custom-xl md:font-medium leading-25 -tracking-stretch mt-5">
          <p className="md:pb-6">

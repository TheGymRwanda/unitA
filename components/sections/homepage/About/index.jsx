  ...
  return (
    <Wrapper>
      <div className='mt-23.75 md:mt-24.5 xl:mt-45.75'>
        ...
        <div className='lg:mt-13.25 xl:mt-0 pb-5 md:py-8.75 xl:py-4.5 text-5.75 font-normal text-secondary-400 md:text-9.5 leading-9 md:leading-12.25 -tracking-stretch mt-5'>
          <p className='md:pb-6'>

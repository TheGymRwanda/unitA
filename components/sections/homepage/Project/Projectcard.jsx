    ...
    <div className='bg-primary-800 p-4 space-y-8 lg:p-8 xl:pr-0 xl:grid grid-cols-2 gap-x-5.57 place-items-center xl:pl-12.75 xl:pt-32.75 xl:pb-26.5 rounded-4xl mb-6 xl:mb-8'>
      <div className='md:max-w-141.75 '>
        <div className='pb-6'>
          ...
          <p className='text-custom-md -tracking-stretch leading-9 lg:text-custom-lg lg:leading-11 text-secondary-400 font-normal'>
            {description}
          </p>
        </div>
      ...
      <Image src={image} alt='unit8' className='w-full xl:h-102 object-left-top object-cover right-0 rounded-lg' />
    </div>
  );
}

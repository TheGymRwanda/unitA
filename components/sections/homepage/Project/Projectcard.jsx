...
const Projectcard = ({ title, description, link, image, width, height }) => {
  return (
    <div className='bg-primary-800 p-4 xl:h-170 w-full space-y-8 lg:p-8 xl:pr-0 xl:grid grid-cols-2 gap-x-5.57 place-items-center xl:pl-12.75 xl:pt-32.75 xl:pb-26.5 rounded-2xl md:rounded-4xl first-of-type:mb-6 md:first-of-type:mb-8 xl:mb-8'>

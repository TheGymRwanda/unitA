...
const ServiceItem = ({ title, description, reverse, index, fadeDir, icon }) => {
  const serviceStyle = classNames(
    "flex flex-col-reverse gap-8 justify-between leading-normal",
  ...
  return (
    <div className={serviceStyle}>
      <div className="flex flex-col gap-4 md:w-2/3 xl:max-w-1/2">
        <div className="text-9.5 lg:text-11.75 lg:-tracking-stretch text-white ">
          {title}
        </div>
